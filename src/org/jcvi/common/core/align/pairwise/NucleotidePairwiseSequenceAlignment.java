...
public class NucleotidePairwiseSequenceAlignment implements PairwiseSequenceAlignment<Nucleotide, NucleotideSequence>{

	private final NucleotideSequenceAlignment delegate;
	private final float score;
	
	
	public NucleotidePairwiseSequenceAlignment(
			NucleotideSequenceAlignment delegate, float score) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NucleotidePairwiseSequenceAlignment other = (NucleotidePairwiseSequenceAlignment) obj;
		if (delegate == null) {
