...
public abstract class AbstractRemoveConsensusBaseEdit<G extends Glyph,E extends EncodedGlyphs<G>> extends AbstractGlyphEdit<G,E>{
     ...
     * @param offset
     */
    public AbstractRemoveConsensusBaseEdit(G tobeInserted, int offset) {
