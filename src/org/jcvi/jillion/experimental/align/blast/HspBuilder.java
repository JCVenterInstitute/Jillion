 ...
 *
 */
public final class HspBuilder<R extends Residue<R>, S extends ResidueSequence<R, S, B>, B extends ResidueSequenceBuilder<R, S,B>> implements org.jcvi.jillion.core.util.Builder<Hsp<R,S,B>>{
    ...
    private static final double ONE_HUNDRED = 100.0D;
        ...
        public static <R extends Residue<R>, S extends ResidueSequence<R, S, B>, B extends ResidueSequenceBuilder<R, S, B>> HspBuilder<R,S, B> copy(Hsp<R,S, B> hsp){
    ...
    private static final class HspImpl<R extends Residue<R>, S extends ResidueSequence<R, S, B>, B extends ResidueSequenceBuilder<R, S, B>> implements Hsp<R,S, B>{
