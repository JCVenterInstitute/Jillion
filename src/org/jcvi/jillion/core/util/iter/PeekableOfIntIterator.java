...
/**
 * a "peekable" version of {@link java.util.PrimitiveIterator.OfInt}.
 *
 * @since 6.1
 */
public interface PeekableOfIntIterator extends PrimitiveIterator.OfInt {
	/**
	 ...
	 *
	 */
	default boolean advanceIf(IntPredicate condition){
		if(!hasNext()){
			return false;
		}
	 ...
	 *
	 */
	default boolean advanceWhile(IntPredicate condition){
