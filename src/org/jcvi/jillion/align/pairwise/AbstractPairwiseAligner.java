 ...
 */
abstract class AbstractPairwiseAligner <R extends Residue<R>, S extends ResidueSequence<R, S, B>, B extends ResidueSequenceBuilder<R, S, B>, A extends SequenceAlignment<R, S>, P extends PairwiseSequenceAlignment<R, S>> {
