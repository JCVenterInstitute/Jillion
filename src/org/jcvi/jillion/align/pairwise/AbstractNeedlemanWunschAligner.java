 ...
 */
abstract class AbstractNeedlemanWunschAligner <R extends Residue<R>, S extends ResidueSequence<R, S, B>, B extends ResidueSequenceBuilder<R, S, B>, A extends SequenceAlignment<R, S>, P extends PairwiseSequenceAlignment<R, S>> extends AbstractPairwiseAligner<R, S, B, A, P>{
