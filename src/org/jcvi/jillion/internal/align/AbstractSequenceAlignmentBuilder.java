...
public abstract class AbstractSequenceAlignmentBuilder
		<R extends Residue<R>, S extends ResidueSequence<R, S,B>, B extends ResidueSequenceBuilder<R, S, B>, A extends SequenceAlignment<R, S>> implements SequenceAlignmentBuilder<R, S,B,A>{
