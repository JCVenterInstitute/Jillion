...
public class TestSaltCorrectionStrategy {
	...
	public void santaLucia(){
		assertEquals(20.737D, SaltCorrectionStrategy.SANTALUCIA_1996.adjustTm(37, 50)
				,0.001D);
		assertEquals(24.5D, SaltCorrectionStrategy.SANTALUCIA_1996.adjustTm(37, 100)
				,0.001D);
		assertEquals(37D, SaltCorrectionStrategy.SANTALUCIA_1996.adjustTm(37, 1000)
				,0.001D);
	}
	@Test
