...
public class TestN50Computations {

	
	@Parameters
	public static List<Object[]> params(){
		return Arrays.asList(
					new Object[]{ 70, new int[]{80,70,50,40,30,20}},
					new Object[]{ 50, new int[]{80,70,50,40,30,20, 10, 5}}
	...
	public TestN50Computations(double expectedAnswer, int[] values) {
	...
	public void intStream(){
		...
		assertEquals(expectedAnswer, GenomeStatistics.n50(stream).getAsInt(), 0.01D);
	}
	...
	public void intXStream(){
		...
		assertEquals(expectedAnswer, GenomeStatistics.nX(stream, .5D).getAsInt(), 0.01D);
	}
	...
	public void XStream(){
		double actual = IntStream.of(values)
									.mapToObj(Long::valueOf)
									.collect(GenomeStatistics.nXCollector(.5D))
									.getAsInt();
