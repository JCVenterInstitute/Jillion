...
public abstract class DefaultIndelDetectorTest<R extends Residue<R>, S extends ResidueSequence<R, S, B>, B extends ResidueSequenceBuilder<R,S,B>> {
	...
	protected IndelDetector<R> getDetectorInstance(){
		return DefaultIndelDetector.create();
	}
	...
	public DefaultIndelDetectorTest(String ignored, String a, String b, List<Indel> expected) {
		this.a = a;
		this.b = b;
	...
	public void findExpectedIndels() {
		List<Indel> actual = consumeArguments(a,b);
	...
	protected abstract S toSequence(String s);
}
