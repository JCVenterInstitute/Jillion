...
import org.jcvi.experimental.primerDesign.results.PrimerDesignResult;
    ...
    private Map<PrimerDesignTarget,Collection<PrimerDesignResult>> getExpectedResults(List<PrimerDesignTarget> targets) {
        ...
        expectedPrimers.add(
            new PrimerDesignResult.Builder()
                ...
                .setPrimerSequence(new NucleotideSequenceBuilder("GAACTTCAGGGTTAGCCTCGTTATC").build())
                .build()
        );
        expectedPrimers.add(
            new PrimerDesignResult.Builder()
                ...
                .setPrimerSequence(new NucleotideSequenceBuilder("CAGGCGTGGTTTATTTCATCTTG").build())
                .build()
        );
        expectedPrimers.add(
            new PrimerDesignResult.Builder()
                ...
                .setOrientation(Direction.REVERSE)
                .setPrimerSequence(new NucleotideSequenceBuilder("GGCGCGGCATAAAGTAAGTATCT").build())
                .build()
        );
        expectedPrimers.add(
            new PrimerDesignResult.Builder()
                ...
                .setOrientation(Direction.FORWARD)
                .setPrimerSequence(new NucleotideSequenceBuilder("TGAAAATTTATGCCTTGAAACCGA").build())
                .build()
        );
        ...
        expectedPrimers.add(
            new PrimerDesignResult.Builder()
                ...
                .setOrientation(Direction.REVERSE)
                .setPrimerSequence(new NucleotideSequenceBuilder("CAGATATTGTCCTGTCGCAGTCA").build())
                .build()
        );
        expectedPrimers.add(
            new PrimerDesignResult.Builder()
                ...
                .setOrientation(Direction.REVERSE)
                .setPrimerSequence(new NucleotideSequenceBuilder("AAGCAAATTTATTGACACCCATCAC").build())
                .build()
        );
        expectedPrimers.add(
            new PrimerDesignResult.Builder()
                ...
                .setOrientation(Direction.FORWARD)
                .setPrimerSequence(new NucleotideSequenceBuilder("CGCCAATATCTTGCTGCATAAAA").build())
                .build()
        );
        expectedPrimers.add(
            new PrimerDesignResult.Builder()
                ...
                .setOrientation(Direction.FORWARD)
                .setPrimerSequence(new NucleotideSequenceBuilder("TCAAGTTTATGTTGCTTGTTACCCTG").build())
                .build()
        );
